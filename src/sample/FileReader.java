...
public class FileReader {
     ...
     * such a 2d array will contain the name and the corresponding value eg: name - 38 however such a value is not neccessarily a number.
     */
    ...
    public ArrayList<String> convertStringtoArray(String line){
